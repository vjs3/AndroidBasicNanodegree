...
private MediaPlayer mediaPlayer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("daughter", "tune", R.drawable.family_daughter, R.raw.family_father));
        ...
        words.add(new Word("older sister", "teṭe", R.drawable.family_older_sister, R.raw.family_father));
